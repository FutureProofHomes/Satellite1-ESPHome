 ...
 *
 * `spark` is optional decoration: { pts, amp, seed } for the area chart in the chip's bottom band
 * (the Home sensor chips wear it; the Presence route's pass nothing and render unchanged).
 */
export function Pill({ id, open, setOpen, label, value, spark }) {
  const on = open === id;
  return (
